<li class="menu_useful">
		<h2>Useful Links</h2> 
		<ul>
		<li onclick=""><a title="Contact Us" href="{$smarty.const.WWW_TOP}/contact-us.php">Contact Us</a></li>
		<li onclick="document.location='{$smarty.const.WWW_TOP}/sitemap.php'"><a title="Site Map" href="{$smarty.const.WWW_TOP}/sitemap.php">Site Map</a></li>
		{if $loggedin=="true"}

...
<table style="margin-top:10px;" class="data Sortable highlight">
	...
	<tr class="{cycle values=",alt"}">
		...
		<td><a title="delete this rage entry" href="{$smarty.const.WWW_TOP}/rage-delete.php?id={$tvrage.ID}">delete</a> | <a title="remove this rageid from all releases" href="{$smarty.const.WWW_TOP}/rage-remove.php?id={$tvrage.rageID}">remove</a></td>
	</tr>
	{/foreach}

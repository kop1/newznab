...
<table style="width:100%;margin-top:40px;" class="data Sortable">
	...
	{foreach from=$results item=result}
		<tr>
			...
			<td nowrap="nowrap">{$result.grabs} grab{if $result.grabs != 1}s{/if}<br/><a title="View comments for {$result.searchname}" href="/details/{$result.searchname}/viewnzb/{$result.guid}#comments">0 cmts</a></td>
		</tr>
	{/foreach}

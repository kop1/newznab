...
<p>
	<ol style="list-style-type:decimal;">
		...
		<li><a href="{$smarty.const.WWW_TOP}/binary-update.php">Get</a> latest headers for active groups.</li>
		<li><a href="{$smarty.const.WWW_TOP}/release-update.php">Update</a> releases.</li>
